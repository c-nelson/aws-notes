CFN-INIT is a powerful desired-state-like configuration engine which is part of the [CloudFormation](CloudFormation.md) suite of products, allowing complex [Bootstrapping](../EC2/Bootstrapping.md).
