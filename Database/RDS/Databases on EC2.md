Running a database directly on an [EC2](../../Compute/EC2/EC2.md) is generally not a good idea unless there is a specific reason you need to do so. The other products like [RDS](RDS.md) are preferable.
